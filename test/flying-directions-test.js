...
vows.describe('FlyingDirections').addBatch({
  ...
  '#onGeocodeDestinationSuccess': {
    'sets destinationLatLng': function() {
  ...
  '#onGeocodeSuccess': {
    ...
    'calls onSuccess when origin and destination have been geocoded': function() {
      directions.isFullyGeocoded = function() { return true };
    ...
    'runs the onError method if the distance is too short': function() {
