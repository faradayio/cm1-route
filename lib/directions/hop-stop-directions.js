...
HopStopDirections.translateRoute = function(hopstopData) {
  var route = {
    ...
    overview_path: GoogleDirectionsRoute.generateOverviewPath(hopstopData.steps)
  };
  route.legs = [{
    ...
    steps: GoogleDirectionsRoute.generateSteps(hopstopData.steps),
    via_waypoints: []
  }];
  route.warnings = [];
  route.bounds = GoogleDirectionsRoute.generateBounds(hopstopData.steps);
